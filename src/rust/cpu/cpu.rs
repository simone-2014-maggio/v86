...
// how many times rdtsc was called and had to return the same value
pub static mut tsc_number_of_same_readings: u64 = 0;
// how often rdtsc is currently called without its value changing, used for interpolating quick
